    ...
    <section id="about" className="py-20 bg-gradient-to-br from-navy to-royal text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 optima-font">Leading Financial Excellence in the UAE</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 optima-font">UAE Market Expertise</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 optima-font">Trusted Partnership</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 optima-font">Proven Performance</h3>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 bg-white text-navy p-6 rounded-2xl shadow-2xl">
              <div className="text-3xl font-bold text-accent-blue optima-font">10+</div>
              <div className="text-sm font-semibold optima-font">Years Experience</div>
            </div>
            
            <div className="absolute -top-8 -right-8 bg-accent-blue text-white p-6 rounded-2xl shadow-2xl">
              <div className="text-3xl font-bold optima-font">500+</div>
              <div className="text-sm font-semibold optima-font">Satisfied Clients</div>
            </div>
          </div>
        </div>
      </div>
